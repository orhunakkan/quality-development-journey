...
tools:
  [
    ...
    'Copilot Container Tools/act_image',
    'Copilot Container Tools/inspect_container',
    'Copilot Container Tools/inspect_image',
    'Copilot Container Tools/list_containers',
    'Copilot Container Tools/list_images',
    'Copilot Container Tools/list_networks',
    'Copilot Container Tools/list_volumes',
    'Copilot Container Tools/logs_for_container',
    'Copilot Container Tools/prune',
    'Copilot Container Tools/run_container',
    'Copilot Container Tools/tag_image',
    'playwright-test/*',
    'playwright/*',
